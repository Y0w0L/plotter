...
def run_worker(args):
    ...
    config["output_file_name"] = f"analysis_py_fluence_part_{worker_id}.root"
...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--output", default="analysis_py_fluence.root", type=str, help="Path for the FINAL merged output ROOT file.")
