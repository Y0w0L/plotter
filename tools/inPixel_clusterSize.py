...
class AnalysisPixelModule:
    ...
    def setup_histograms(self):
        ...
        self.histograms["inPixel_residual_r_cs1"] = ROOT.TProfile2D("inPixel_residual_r_cs1", ";x/pitch [um];y/pitch [um];residual r [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_r_cs2"] = ROOT.TProfile2D("inPixel_residual_r_cs2", ";x/pitch [um];y/pitch [um];residual r [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_r_cs3"] = ROOT.TProfile2D("inPixel_residual_r_cs3", ";x/pitch [um];y/pitch [um];residual r [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_r_cs4"] = ROOT.TProfile2D("inPixel_residual_r_cs4", ";x/pitch [um];y/pitch [um];residual r [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_r_cs5"] = ROOT.TProfile2D("inPixel_residual_r_cs5", ";x/pitch [um];y/pitch [um];residual r [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_x_cs1"] = ROOT.TProfile2D("inPixel_residual_x_cs1", ";x/pitch [um];y/pitch [um];residual x [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_x_cs2"] = ROOT.TProfile2D("inPixel_residual_x_cs2", ";x/pitch [um];y/pitch [um];residual x [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_x_cs3"] = ROOT.TProfile2D("inPixel_residual_x_cs3", ";x/pitch [um];y/pitch [um];residual x [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_x_cs4"] = ROOT.TProfile2D("inPixel_residual_x_cs4", ";x/pitch [um];y/pitch [um];residual x [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_x_cs5"] = ROOT.TProfile2D("inPixel_residual_x_cs5", ";x/pitch [um];y/pitch [um];residual x [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)
        self.histograms["inPixel_residual_y_cs1"] = ROOT.TProfile2D("inPixel_residual_y_cs1", ";x/pitch [um];y/pitch [um];residual y [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)        
        self.histograms["inPixel_residual_y_cs2"] = ROOT.TProfile2D("inPixel_residual_y_cs2", ";x/pitch [um];y/pitch [um];residual y [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)        
        self.histograms["inPixel_residual_y_cs3"] = ROOT.TProfile2D("inPixel_residual_y_cs3", ";x/pitch [um];y/pitch [um];residual y [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)        
        self.histograms["inPixel_residual_y_cs4"] = ROOT.TProfile2D("inPixel_residual_y_cs4", ";x/pitch [um];y/pitch [um];residual y [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)        
        self.histograms["inPixel_residual_y_cs5"] = ROOT.TProfile2D("inPixel_residual_y_cs5", ";x/pitch [um];y/pitch [um];residual y [um]", inpixel_bins_x, -pitch_x / 2, pitch_x / 2, inpixel_bins_y, -pitch_y / 2, pitch_y / 2)        
    ...
    def run_analysis(self):
        ...
        for i in range(self.n_entries):
            ...
            for clus in clusters:
                ...
                cluster_size = clus.size

                if 1 <= cluster_size <=5:
                    key_r = f"inPixel_residual_r_cs{cluster_size}"
                    key_x = f"inPixel_residual_x_cs{cluster_size}"
                    key_y = f"inPixel_residual_y_cs{cluster_size}"

                    buffer[key_r].append((in_pixel_pos[0], in_pixel_pos[1], residual_r))
                    buffer[key_x].append((in_pixel_pos[0], in_pixel_pos[1], abs(residual_vec[0])))
                    buffer[key_y].append((in_pixel_pos[0], in_pixel_pos[1], abs(residual_vec[1])))
                # --------------------------------------------------------
    ...
    def finalize(self):
        ...
        output_filename = self.config.get("output_file_name", "analysis_inPixel_clsize.root")
